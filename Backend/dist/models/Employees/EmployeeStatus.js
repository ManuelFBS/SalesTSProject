...
exports.default = setupEmployeeStatusRelations;
...
EmployeeStatus.init({
    ...
    statusWork: {
        type: sequelize_1.DataTypes.ENUM('Activo', 'Vacaciones', 'Permiso Laboral', 'Reposo Médico', 'Suspendido', 'Desincorporado'),
        defaultValue: 'Activo',
    },
    statusUser: {
...
function setupEmployeeStatusRelations() {
